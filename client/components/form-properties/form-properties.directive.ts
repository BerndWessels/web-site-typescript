...
((): void => {
  ...
  function directive($window: ng.IWindowService): ng.IDirective {
    return <ng.IDirective> {
      ...
      link: link,
      controller: 'formProperties.FormPropertiesController',
      controllerAs: 'vm',
      template: components.formProperties.formPropertiesTemplate
    };
    /**
  ...
  angular.module('formProperties').directive('formProperties', directive);
})();
